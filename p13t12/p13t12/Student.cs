...
namespace p13t12
{
    class Student
    {
        ...
        public Student(string sn, string sc, bool st, int mm, int mg, int em, int eg, int hm, int hg)//בנאי מקבל ערכים
        {
            this.StudentName = sn;
        ...
        public void SetStudentName(string sn)//SET STUDENT NAME
        {
            this.StudentName = sn;
        }
        ...
        public string toString()//To string
        {
            if (this.StudentTrend)
            {
                string str = "student name: " + this.StudentName + ", class: " + this.StudentClass + ", trend: technology,  math mark: " + this.MathMark + ", math group: " + this.MathGroup + ", english mark: " + this.EnglishMark + ", english group" + this.EnglishGroup + ", history mark: " + this.HisMark + ", history group: " + this.HisGroup;
                return str;
            }
            else
            {
                string str = "student name: " + this.StudentName + ", class: " + this.StudentClass + ", trend: academic,  math mark: " + this.MathMark + ", math group: " + this.MathGroup + ", english mark: " + this.EnglishMark + ", english group" + this.EnglishGroup + ", history mark: " + this.HisMark + ", history group: " + this.HisGroup;
                return str;
            }
